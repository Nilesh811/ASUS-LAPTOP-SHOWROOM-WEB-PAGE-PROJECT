...
<head>
    ...
    <title>ASUS Premium Showroom - Admin Login</title>
...
<body>
    <div class="login-container">
        <div class="login-box">
            ...
            <h2 class="login-title">ADMIN DASHBOARD LOGIN</h2>
    ...
    <div class="notification" id="notification">
        ...
        <span id="notification-message">Welcome to ASUS Admin Dashboard</span>
    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#loginForm').submit(function (e) {
                ...
                showNotification('Authenticating... Please wait');
                ...
                setTimeout(function () {
                    ...
                    if (username === 'nilesh' && password === '1234') {
                        ...
                        setTimeout(function () {
                            window.location.href = 'adm-dashboard2.py';
                        }, 1500);
                    } else {
            ...
            setTimeout(function () {
                showNotification('Welcome to ASUS Admin Dashboard Login');
            }, 1000);
        });
    </script>
</body>
